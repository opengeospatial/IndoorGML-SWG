...
== Overview of IndoorJSON

IndoorJSON implements the conceptual classes of <<ogc22-045r5,IndoorGML 2.0 Part 1>> as JSON objects.
...
image::../figures/indoorgml_core_structure.svg[align="center"]

The IndoorJSON Core schema follows <<fig-core-indoorgml>>.
Each class is defined individually, and depending on their relationships, they can hold other classes as property values or array values.
...
image::../figures/indoorgml_navi_structure.svg[align="center"]

The IndoorJSON Navigation schema follows <<fig-navi-indoorgml>>.
In the figure, the arrows represent inheritance.
...
IndoorJSON use JSON-FG-compatible geometry objects for the geometry representation.
