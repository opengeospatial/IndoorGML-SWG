...
:external-id: http://www.opengis.net/doc/IS/indoorjson/2.0
:comment: ### Author one
:fullname: Taehoon Kim
:comment: ### Author two
:fullname_2: Abdoulaye Diakite
:comment: ### Author three
:fullname_3:  Ki-Joune Li
:fullname_4:  Sisi Zlatanova
:fullname_4:  Zhiyong Wang
:comment: ### Role of the authors; mandatory
:role: editor
:comment: ### Comma delimited keywords; mandatory
:keywords: OGCDoc, OGC documents, indoor, navigation, IndoorGML, JSON, GeoJSON, JSON-FG
:comment: ### Semicolon-delimited list of the submitting organizations; mandatory
:submitting-organizations: The University of New South Wales; Pusan National University; CityGeometrix; National Institute of Advanced Industrial Science and Technology;SpatialAlgebra Technology Limited;
...
include::sections/07-indoorjson_core.adoc[]
include::sections/08-indoorjson_navi.adoc[]
