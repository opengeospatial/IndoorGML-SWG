...
Following the <<OGC_08-131r3,OGC ModSpec guidance (OGC, 2009)>>, IndoorGML Part 1 – Conceptual Model is organized into a Core module and Extension modules that have one or more mandatory dependencies on the Core (see <<fig-modular>>).
...
[[fig-modular]]
.Modular organization of IndoorGML
