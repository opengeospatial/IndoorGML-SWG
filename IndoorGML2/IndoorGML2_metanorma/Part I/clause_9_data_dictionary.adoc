...
.3+| *Aggregation*  | *Role name*       | *Class and Cardinality*
...
| *Super classes*   2+| GML AbstractFeature
.3+| *Association*    | *Role name*    | *Class and Cardinality*
...
| *Super classes*   2+| GML AbstractFeature
.2+| *Association*    | *Role name*    | *Class and Cardinality*
                      | duality        | Edge [0..1]
...
| *Super classes*   2+| GML AbstractFeature
.3+| *Composition*    | *Role name*    | *Class and Cardinality*
                      | nodeMember     | Node [1..*]
                      | edgeMember     | Edge [0..*]
...
| *Super classes*   2+| GML AbstractFeature
.4+| *Association*  | *Role name*       | *Class and Cardinality*
